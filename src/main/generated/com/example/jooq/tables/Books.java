...
import com.example.jooq.tables.BookAuthorRelations.BookAuthorRelationsPath;
...
public class Books extends TableImpl<BooksRecord> {
     ...
     */
    public final TableField<BooksRecord, Long> BOOK_ID = createField(DSL.name("book_id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");
     ...
     */
    public final TableField<BooksRecord, Integer> PUBLICATION_STATUS = createField(DSL.name("publication_status"), SQLDataType.INTEGER.nullable(false), this, "");
    ...
    private transient BookAuthorRelationsPath _bookAuthorRelations;

    /**
     * Get the implicit to-many join path to the
     * <code>public.book_author_relations</code> table
     */
    public BookAuthorRelationsPath bookAuthorRelations() {
        if (_bookAuthorRelations == null)
            _bookAuthorRelations = new BookAuthorRelationsPath(this, null, Keys.BOOK_AUTHOR_RELATIONS__FK_BAR_BOOK.getInverseKey());

        return _bookAuthorRelations;
    }
    ...
    public AuthorsPath authors() {
        return bookAuthorRelations().authors();
    }
    ...
    public List<Check<BooksRecord>> getChecks() {
        return Arrays.asList(
            ...
            Internal.createCheck(this, DSL.name("books_publication_status_check"), "((publication_status = ANY (ARRAY[0, 1])))", true)
        );
    }
