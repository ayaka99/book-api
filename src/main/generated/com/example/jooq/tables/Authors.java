...
public class Authors extends TableImpl<AuthorsRecord> {
     ...
     */
    public final TableField<AuthorsRecord, Long> AUTHOR_ID = createField(DSL.name("author_id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");
    ...
    public BookAuthorRelationsPath bookAuthorRelations() {
        if (_bookAuthorRelations == null)
            _bookAuthorRelations = new BookAuthorRelationsPath(this, null, Keys.BOOK_AUTHOR_RELATIONS__FK_BAR_AUTHOR.getInverseKey());
    ...
    public BooksPath books() {
        return bookAuthorRelations().books();
    }
